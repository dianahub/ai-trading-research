    ...
    <div>
      ...
      >
        ...
        <div className="flex items-center gap-1.5">
          <span style={{ color: '#e2e8f0', fontSize: 13, fontWeight: 700, letterSpacing: '0.05em' }}>{open ? 'HIDE' : 'SHOW'}</span>
...
export default function OpportunitiesRisks({ analysis }) {
  ...
  return (
    <div className="rounded-xl h-full flex flex-col" style={{ background: '#111827', border: '1px solid #38bdf8' }}>
