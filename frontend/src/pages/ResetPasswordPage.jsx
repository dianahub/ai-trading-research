...
function PasswordInput({ value, onChange, placeholder, autoFocus }) {
  ...
  return (
    <div style={{ position: 'relative' }}>
      <input type={show ? 'text' : 'password'} value={value} autoFocus={autoFocus}
        onChange={onChange}
        className="w-full px-3 py-2.5 rounded-lg text-sm outline-none"
        style={{ background: '#0f1a2e', border: '1px solid #1e2d45', color: '#e2e8f0', paddingRight: '2.5rem' }}
        ...
        <div className="rounded-2xl p-8" style={{ background: '#0b1120', border: '1px solid #1e2d45' }}>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <PasswordInput value={form.password} autoFocus
