        ...
        {submitted ? (
          ...
          <>
            ...
            <div className="rounded-2xl p-8" style={{ background: '#0b1120', border: '1px solid #1e2d45' }}>
              <a
                href={`${API}/auth/oauth/google?redirect=/dashboard${ref ? `&ref=${ref}` : ''}`}
                className="flex items-center justify-center gap-3 w-full py-3 rounded-xl text-sm font-semibold mb-5 transition-all"
